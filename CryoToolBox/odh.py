"""Oxygen Deficiency Hazard analysis tools.

The models in this module are based primarily on Fermilab ES&H Manual chapter
4240 together with simple room-mixing and ventilation assumptions. The module
includes source/leak modeling, ventilation and power availability models, and
reporting helpers for ODH review workflows.
"""
...
class ODHError(Exception):
    """Base exception for oxygen deficiency hazard calculations."""


class ConstLeakTooBig(Exception):
    """Raised when a constant leak exceeds the modeled room capacity."""


class ConstLeakTooLong(Exception):
    """Raised when a constant leak duration exceeds the modeled time window."""


@ureg.check(None, None, '1/[time]', '[length]^3/[time]', '[time]', None)
@dataclass
class Leak:
    """Describe a probabilistic inert-gas leak generated by a source."""
    name: str
    fluid: ThermState
...
@dataclass
class ConstLeak:
    """Describe a constant, non-probabilistic inert-gas release scenario."""
...
class Source:
    """Source of inert gas that can contribute one or more leak scenarios."""
...
class BuildPower:
    ...
    @property
    def pfd(self):
        """Combined probability of power and backup-system unavailability."""
        return self.power_pfd * self.backup_pfd

    def info(self):
        """Return a short human-readable summary of the power model."""
...
class BuildVent:
    ...
    def const_vent(self, fail_case):
        """Return the constant ventilation available for a given failure case."""
    ...
    def fan_flowrates(self):
        """Return probability/flow tuples for all fan-availability states."""
    ...
    def info(self):
        """Return a short human-readable summary of the ventilation model."""
...
class Volume:
    ...
    @property
    def phi(self):
        """Total fatality rate summed over all analyzed failure modes."""
    ...
    def info(self):
        """Print a short human-readable summary of the volume inputs."""
