...
from CryoToolBox import geometry as g
import pprint
import unittest
from math import pi
...
class PipingTest(unittest.TestCase):
    ...
    def test_direct_integration_nitrogen_P165_T80(self):
        ...
        self.assertApproxEqual(40147*u.kg/(u.s*u.m**2),
                               G_nozzle,
                               uncertainty=0.01)
        self.assertApproxEqual(19.26*u.psi,
                               P_2,
                               uncertainty=0.01)
    ...
    def test_direct_integration_nitrogen_P165_T90(self):
        ...
        fluid = ht.ThermState('nitrogen', P=P, T=T)
        G_nozzle, P_2 = ht.piping.G_nozzle(fluid)
        self.assertApproxEqual(34133.4*u.kg/(u.s*u.m**2),
                               G_nozzle,
                               uncertainty=0.01)
        self.assertApproxEqual(52.2416*u.psi,
                               P_2,
                               uncertainty=0.05)
    ...
    def test_direct_integration_nitrogen_P165_100(self):
        ...
        self.assertApproxEqual(22655.1*u.kg/(u.s*u.m**2),
                               G_nozzle,
                               uncertainty=0.01)
        self.assertApproxEqual(111.4025*u.psi,
                               P_2,
                               uncertainty=0.01)
    ...
    def test_direct_integration_nitrogen_P165_Q0(self):
        ...
        G_nozzle, P_2 = ht.piping.G_nozzle(fluid, n_steps=150)
        self.assertApproxEqual(11268.4*u.kg/(u.s*u.m**2),
                               G_nozzle,
                               uncertainty=0.01)
        self.assertApproxEqual(124.4172*u.psi,
                               P_2,
                               uncertainty=0.01)
    ...
    def test_direct_integration_nitrogen_P165_Q025(self):
        ...
        fluid = ht.ThermState('nitrogen', P=P, Q=Q)
        G_nozzle, P_2 = ht.piping.G_nozzle(fluid, n_steps=150)
        self.assertApproxEqual(7472.6*u.kg/(u.s*u.m**2),
                               G_nozzle,
                               uncertainty=0.01)
        self.assertApproxEqual(105.4028*u.psi,
                               P_2,
                               uncertainty=0.01)
    ...
    def test_direct_integration_nitrogen_P165_Q05(self):
        ...
        fluid = ht.ThermState('nitrogen', P=P, Q=Q)
        G_nozzle, P_2 = ht.piping.G_nozzle(fluid)
        self.assertApproxEqual(6043.5*u.kg/(u.s*u.m**2),
                               G_nozzle,
                               uncertainty=0.01)
        self.assertApproxEqual(99.6527*u.psi,
                               P_2,
                               uncertainty=0.01)
    ...
    def test_direct_integration_nitrogen_P165_Q075(self):
        ...
        fluid = ht.ThermState('nitrogen', P=P, Q=Q)
        G_nozzle, P_2 = ht.piping.G_nozzle(fluid)
        self.assertApproxEqual(5218*u.kg/(u.s*u.m**2),
                               G_nozzle,
                               uncertainty=0.01)
        self.assertApproxEqual(96.7808*u.psi,
                               P_2,
                               uncertainty=0.01)
    ...
    def test_direct_integration_nitrogen_P165_Q1(self):
        ...
        self.assertApproxEqual(4661.2*u.kg/(u.s*u.m**2),
                               G_nozzle,
                               uncertainty=0.01)
        self.assertApproxEqual(95.0221*u.psi,
                               P_2,
                               uncertainty=0.01)
    ...
    def test_direct_integration_nitrogen_P165_T150(self):
        ...
        fluid = ht.ThermState('nitrogen', P=P, T=T)
        G_nozzle, P_2 = ht.piping.G_nozzle(fluid, n_steps=250)
        self.assertApproxEqual(3829*u.kg/(u.s*u.m**2),
                               G_nozzle,
                               uncertainty=0.01)
        self.assertApproxEqual(87.186*u.psi,
                               P_2,
                               uncertainty=0.01)
    ...
    def test_direct_integration_nitrogen_P165_T300(self):
        ...
        self.assertApproxEqual(2620.8*u.kg/(u.s*u.m**2),
                               G_nozzle,
                               uncertainty=0.01)
        self.assertApproxEqual(86.92*u.psi,
                               P_2,
                               uncertainty=0.01)
    ...
    def test_direct_integration_nitrogen_P495_T126_5(self):
        ...
        self.assertApproxEqual(16354.4*u.kg/(u.s*u.m**2),
                               G_nozzle,
                               uncertainty=0.01)
        self.assertApproxEqual(306.1692*u.psi,
                               P_2,
                               uncertainty=0.01)
